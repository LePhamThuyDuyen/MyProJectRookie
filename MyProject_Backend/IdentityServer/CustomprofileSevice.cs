...
{
    public class CustomprofileSevice : IProfileService
    {
        private readonly ILogger<CustomprofileSevice> _logger;
        private readonly UserManager<User> _userManager;

        public CustomprofileSevice(UserManager<User> userManager, ILogger<CustomprofileSevice> logger)
        {
            _logger = logger;
